...
module OmniAuth
  module Strategies
    class KakaoOauth2 < OmniAuth::Strategies::OAuth2
      ...
      AUTHORIZE_TOKEN_URL = 'https://kauth.kakao.com/oauth/token'
      TOKEN_INFO_URL = 'https://kauth.kakao.com/oauth/tokeninfo'

      option :name, 'kakao_oauth2'
      ...
      def get_access_token(request)
        ...
        if verifier && request.xhr?
          ...
          begin
            ...
            warn "[omniauth omniauth-kakao] JSON parse error=#{e}"
          end
        end
      end
      ...
      def token_info(access_token)
        ...
        @token_info ||= Hash.new do |h, k|
          h[k] = client.request(:post, TOKEN_INFO_URL, body: { access_token: access_token }).parsed
        end
